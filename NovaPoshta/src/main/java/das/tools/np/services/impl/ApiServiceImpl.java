...
public class ApiServiceImpl implements ApiService {
    ...
    public ApiServiceImpl(RestTemplate restTemplate, ConfigService configService, ConversionService conversionService, CommonService commonService, NumberToPhoneRepository numberToPhoneRepository) {
